...
__decorate([
    (0, common_1.Post)(),
    (0, response_decorator_1.ResponseMessage)("Create a new User"),
...
__decorate([
    (0, common_1.Get)(),
    (0, response_decorator_1.ResponseMessage)("Fetch user with paginate"),
...
__decorate([
    ...
    (0, common_1.Get)(':id'),
    (0, response_decorator_1.ResponseMessage)("Fetch user by id"),
...
__decorate([
    (0, response_decorator_1.ResponseMessage)("Update a User"),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
